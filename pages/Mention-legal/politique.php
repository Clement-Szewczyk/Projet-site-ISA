...
<html>
  ...
  <body>
    ...
    <main class="espace">
      <div class="premier">
        <h1 class="Titre1">Politique de Confidentialité</h1>
      </div>
      <ul class="list">
        <li>
          <article class="article">
            <h2 class="Titre2">Le but de cette politique de confidentialité :</h2>
            <p>
                Le but de cette politique de confidentialité est d'informer les utilisateurs de notre site des données
                personnelles que nous recueillerons ainsi que les informations suivantes, le cas échéant :</br>
                ...
                e. La politique de cookies du site</br></br>
        ...
        <li>
          <article class="article">
            ...
            <p>
                ...
                incompatible avec les finalités initiales (limitation des finalités) ;</br>
                c. adéquates, pertinentes et limitées à ce qui est nécessaire au regard des finalités pour
                lesquelles elles sont traitées (minimisation des données) ;</br>
                ...
                lesquelles elles sont traitées, soient effacées ou rectifiées sans tarder (exactitude) ;</br>
                ...
                droits et libertés de la personne concernée (limitation de la conservation) ;</br>
                ...
                organisationnelles appropriées (intégrité et confidentialité).</br></br>
                ...
                personnel, notamment lorsque la personne concernée est un enfant.</br>
                ...
                politique pour nous conformer à la loi pertinente.</br></br>
            </p>
          </article>
        </li>
        <li>
          <article class="article">
            <h2 class="Titre2">Consentement :</h2>
            <p>
                Les utilisateurs conviennent qu’en utilisant notre site, ils consentent à :</br>
                a. les conditions énoncées dans la présente politique de confidentialité et</br>
                b. la collecte, l’utilisation et la conservation des données énumérées dans la présente politique.</br></br>
            </p>
          </article>
        </li>
        <li>
          <article class="article">
            <h2 class="Titre2">Données collectées automatiquement :</h2>
            <p>
                ...
                b. Contenu que l’utilisateur consulte sur votre site</br></br>
            </p>
          </article>
        </li>
        <li>
          <article class="article">
            <h2 class="Titre2">Données recueillies de façon non automatique :</h2>
            <p>
                Nous pouvons également collecter les données suivantes lorsque vous effectuez certaines fonctions
                sur notre site :</br>
                a. Prénom et nom</br>
                b. Information de paiement</br></br>
                Ces données peuvent être recueillies au moyen des méthodes suivantes :</br>
                _ Enregistrement d'un compte</br>
                _ Paiement</br></br>
                ...
                vous en informer au préalable.</br></br>
            </p>
          </article>
        </li>
        <li>
          <article class="article">
            <h2 class="Titre2">Comment nous utilisons les données personnelles :</h2>
            <p>
                ...
                vos données au-delà de ce que nous divulguerons.</br>
            </p>
          </article>
        </li>
        <li>
          <article class="article">
            <h2 class="Titre2">Divulgations :</h2>
            <p>
                ...
                d. à des acheteurs ou des acheteurs potentiels de cette société dans le cas où nous cherchons à la
                vendre la société</br></br>
                Si vous suivez des hyperliens de notre site vers un autre site, veuillez noter que nous ne sommes pas
                responsables et n’avons pas de contrôle sur leurs politiques et pratiques de confidentialité.</br></br>
            </p>
          </article>
        </li>
        <li>
          <article class="article">
            <h2 class="Titre2">Combien de temps nous stockons les données personnelles :</h2>
            <p>
                Nous ne conservons pas les données des utilisateurs au-delà de ce qui est nécessaire pour atteindre
                les fins pour lesquelles elles sont recueillies.</br></br>
            </p>
          </article>
        </li>
        <li>
          <article class="article">
            <h2 class="Titre2">Comment nous protégeons vos données personnelles :</h2>
            <p>
                ...
                employés spécialisés, les données sont cryptées pour les autres. Nos employés sont liés par des
                accords de confidentialité stricts et une violation de cet accord entraînerait le licenciement de
                l'employé.</br>
                ...
                garantir la sécurité des données des utilisateurs au-delà de ce qui est raisonnablement pratique.</br></br>
            </p>
          </article>
        </li>
        <li>
          <article class="article">
            <h2 class="Titre2">Vos droits en tant qu’utilisateur :</h2>
            <p>
                ...
                f. droit d'objection</br>
                Vous trouverez de plus amples informations sur ces droits au chapitre 3 (art 12-23) du RGPD.</br></br>
            </p>
          </article>
        </li>
        <li>
          <article class="article">
            <h2 class="Titre2">Comment modifier, supprimer ou contester les données recueillies :</h2>
            <p>
                Si vous souhaitez que vos renseignements soient supprimés ou modifiés d’une façon ou d’une autre,
                veuillez communiquer avec notre agent de protection de la vie privée ici :</br></br>
                Théo Rouiller</br>
                therock@gmail.com</br></br>
            </p>
          </article>
        </li>
        <li>
          <article class="article">
            ...
            <p>
                ...
                des changements apportés à cette politique</br></br>
            </p>
          </article>
        </li>
        <li>
          <article class="article">
            ...
            <p>
                ...
                suit :</br>
                adibaba@gmail.com</br>
                18 rue Saint Jean-Baptiste, 59000, Lille</br></br>
            </p>
          </article>
        </li>
      </ul>
